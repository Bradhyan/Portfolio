export const LibraryComponentCode = `
"use client";
...
<section className="grid grid-cols-1 lg:grid-cols-[260px_1fr] min-h-[600px] bg-black/60 backdrop-blur-[50px] rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
