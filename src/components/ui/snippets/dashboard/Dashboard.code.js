export const DashboardCode = `import React, { useState } from "react";

export default function DashboardPro({ preview }) {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white flex">
      ...
      {/* SIDEBAR */}
      <aside className={"bg-slate-800 p-5 transition-all print:hidden "+(sidebarOpen?"w-64":"w-16")}
