...
export const featuredProjects = [
{
    ...
    challenge: "Synchronize massive amounts of data used daily by the area, optimizing its handling and the traceability of the equipment.",
    solution: "Website for internal use by the Analytics area of ​​the company ITSinfoCom, created with next.js along with postgreSQL, hosted within the company's internal server and with exclusive access through the company's vpn, a large structure is created for the entry and administration of data in order to optimize the administration of the area.",
